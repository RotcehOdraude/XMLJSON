...
class MainActivity : AppCompatActivity() {
    ...
    private val ipPuerto = "192.168.68.59:8080"
    ...
    private fun studentID() {
        ...
        val jsonRequest = object : JsonObjectRequest(
            ...
            Response.Listener<JSONObject> { response ->
                binding.outText.text =
                    "${response.get("cuenta").toString()} --- ${response.get("nombre")}\n"
            },
            Response.ErrorListener {
                binding.outText.text = "No se encuentra la información, revise la conexion "
            }
    ...
    private fun buscar() {
        var stringRequest = object : StringRequest(
            ...
            Response.ErrorListener {
                binding.outText.text = "No se encuentra la información, revise su conexión"
            }
        ) {
            override fun getHeaders(): MutableMap<String, String> {
                val headers = HashMap<String, String>()
    ...
    private fun studentXML() {
        ...
        val stringRequest = object : StringRequest(
            ...
            Response.ErrorListener {
                binding.outText.text = "No se encuentra la información, revise su conexion"
            }
        ) {
            override fun getHeaders(): MutableMap<String, String> {
                val headers = HashMap<String, String>()
